...
export function MenuItemCard({ item, priority = false, clickable = false }: MenuItemCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 p-4">
        ...
        {clickable ? <p className="text-xs font-medium text-brand-dark/70">Click to add to cart</p> : null}
      </div>
    </article>
  );
}
