  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        accent: "border-transparent bg-brand-accent text-brand-dark",
        outline: "border-brand-dark/40 text-brand-dark",
        muted: "border-brand-dark/20 bg-brand-dark/10 text-brand-dark"
      }
    },
    defaultVariants: {
      variant: "default"
